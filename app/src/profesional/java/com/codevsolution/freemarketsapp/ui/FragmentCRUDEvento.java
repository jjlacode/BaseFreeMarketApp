...
public class FragmentCRUDEvento extends FragmentCRUD implements Interactor.ConstantesPry,
    ...
    protected void setInicio() {
            ...
            public void onClick(View v) {
                new Dialogos.PaletaColoresDialog(new Dialogos.PaletaColoresDialog.OnClick() {
                    ...
                    public void onClick(String color) {
                        ...
                        actualizarCampo(modeloSQL, EVENTO_COLOR, color);
        ...
        generarAviso.setOnClickListener(v -> {
            ...
            if (fechaaviso > 0 && TimeDateUtil.ahora() < fechaHoraEvento - fechaaviso) {
                ...
                if (avisoDias.getLinearLayout().getVisibility() == View.VISIBLE) {
                    ...
                    actualizarCampo(modeloSQL, EVENTO_AVISO, fechaaviso);
                    visible(textAviso);
                    ...
                    actualizarCampo(modeloSQL, EVENTO_AVISO, 0);
                }
        ...
        chNotificado.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                if (!isChecked) {
                    notificado = 0;
                    actualizarCampo(modeloSQL, EVENTO_NOTIFICADO, 0);
                    gone(chNotificado);
                    visible(aviso);
                    aviso.setChecked(false);
                    gone(textAviso);
                    ...
                    notificado = 1;
                    actualizarCampo(modeloSQL, EVENTO_NOTIFICADO, 1);
                    aviso.setChecked(false);
                    actualizarCampo(modeloSQL, EVENTO_AVISO, 0);
                    gone(generarAviso);
                    gone(vistaAviso.getViewGroup());
                ...
                actualizarCampo(modeloSQL, EVENTO_NOTIFICADO, notificado);
                modeloSQL = updateModelo(modeloSQL);
            }
        });
        ...
        proyRel.setClickAccion(new EditMaterialLayout.ClickAccion() {
            ...
            public void onClickAccion(View view) {
                ...
                actualizarCampoNull(modeloSQL, EVENTO_PROYECTOREL);
                actualizarCampoNull(modeloSQL, EVENTO_NOMPROYECTOREL);
                actualizarCampoNull(modeloSQL, EVENTO_CLIENTEREL);
                actualizarCampoNull(modeloSQL, EVENTO_NOMCLIENTEREL);
                updateModelo(modeloSQL);
        ...
        completada.setOnCheckedChangeListener((buttonView, isChecked) -> {
            ...
            if (isChecked) {
                ...
                actualizarCampo(modeloSQL, EVENTO_COMPLETADA, 100);
            } else {
    ...
    protected void setDatos() {
        ...
        if (modeloSQL.getString(EVENTO_RUTAFOTO) == null) {
            ...
            actualizarCampo(modeloSQL, EVENTO_RUTAFOTO, path);
        }
        ...
        if (checkQueryList(CAMPOS_NOTA, NOTA_ID_RELACIONADO, id)) {
            btnVerNotas.setVisibility(View.VISIBLE);
        }else{
    ...
    private void comprobarCliProy(){
        ...
        if (proyecto != null) {
            ...
            proyRel.setText(nombreProyecto);
            visible(proyRel.getLinearLayout());
            actualizarCampo(modeloSQL, EVENTO_PROYECTOREL, idProyecto);
            actualizarCampo(modeloSQL, EVENTO_NOMPROYECTOREL, nombreProyecto);
            cliente = updateModelo(CAMPOS_CLIENTE, proyecto.getString(PROYECTO_ID_CLIENTE));
            ...
            actualizarCampo(modeloSQL, EVENTO_CLIENTEREL, idCliente);
            actualizarCampo(modeloSQL, EVENTO_NOMCLIENTEREL, nombreCliente);
            actualizarCampo(modeloSQL, EVENTO_TELEFONO, cliente.getString(CLIENTE_TELEFONO));
            actualizarCampo(modeloSQL, EVENTO_DIRECCION, cliente.getString(CLIENTE_DIRECCION));
            actualizarCampo(modeloSQL, EVENTO_EMAIL, cliente.getString(CLIENTE_EMAIL));
    ...
    private boolean mostrarDialogoBorrarRep(final String idEvento) {
        ...
        modeloSQL = queryObject(campos, idEvento);
        ...
        builder.setItems(opciones, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                if (opciones[which].equals("Borrar sólo este modeloSQL")) {
                    ...
                    if (borrarRegistro(TABLA_EVENTO, idEvento) > 0) {
                    ...
                    if (consultaBD.deleteRegistros(TABLA_EVENTO, seleccion) > 0) {
                        ...
                        actualizaRegistro(tabla, idEvento, valores);
                        modeloSQL = updateModelo(campos, idEvento);
                        idMulti = null;
                        Toast.makeText(contexto, "Regitros borrados", Toast.LENGTH_SHORT).show();
                        listab = null;
                        selector();
            ...
            completa.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
                ...
                public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                    ...
                    if (isChecked) {
                        ...
                        actualizarRegistro(TABLA_EVENTO, modeloSQL.getString
        ...
        DatePickerFragment newFragment = DatePickerFragment.newInstance
                (hoy(), new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker datePicker, int year, int month, int day) {
                        ...
                        actualizarCampo(modeloSQL, EVENTO_FECHAINIEVENTO, finiEvento);
                        actualizarCampo(modeloSQL, EVENTO_FECHAINIEVENTOF, selectedDate);
                        if (ffinEvento == 0) {
                            actualizarCampo(modeloSQL, EVENTO_FECHAFINEVENTO, finiEvento);
                            actualizarCampo(modeloSQL, EVENTO_FECHAFINEVENTOF, selectedDate);
                        }
                        modeloSQL = updateModelo(modeloSQL);
        ...
        DatePickerFragment newFragment = DatePickerFragment.newInstance
                (hoy(), new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker datePicker, int year, int month, int day) {
                        ...
                        actualizarCampo(modeloSQL, EVENTO_FECHAFINEVENTO, ffinEvento);
                        actualizarCampo(modeloSQL, EVENTO_FECHAFINEVENTOF, selectedDate);
                        if (finiEvento == 0) {
                            actualizarCampo(modeloSQL, EVENTO_FECHAINIEVENTO, ffinEvento);
                            actualizarCampo(modeloSQL, EVENTO_FECHAINIEVENTOF, selectedDate);
                        }
                        modeloSQL = updateModelo(modeloSQL);
                        fechaFin.setText(selectedDate);
        ...
        TimePickerFragment newFragment = TimePickerFragment.newInstance
                (hoy(), new TimePickerDialog.OnTimeSetListener() {
                    ...
                    public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                        ...
                        actualizarCampo(modeloSQL, EVENTO_HORAINIEVENTO, hiniEvento);
                        actualizarCampo(modeloSQL, EVENTO_HORAINIEVENTOF, selectedHour);
                        if (hfinEvento == 0) {
                            actualizarCampo(modeloSQL, EVENTO_HORAFINEVENTO, hiniEvento);
                            actualizarCampo(modeloSQL, EVENTO_HORAFINEVENTOF, selectedHour);
                        }
                        modeloSQL = updateModelo(modeloSQL);
        ...
        TimePickerFragment newFragment = TimePickerFragment.newInstance
                (hoy(), new TimePickerDialog.OnTimeSetListener() {
                    ...
                    public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                        ...
                        actualizarCampo(modeloSQL, EVENTO_HORAFINEVENTO, hfinEvento);
                        actualizarCampo(modeloSQL, EVENTO_HORAFINEVENTOF, selectedHour);
                        if (hiniEvento == 0) {
                            actualizarCampo(modeloSQL, EVENTO_HORAINIEVENTO, hfinEvento);
                            actualizarCampo(modeloSQL, EVENTO_HORAINIEVENTOF, selectedHour);
                        }
                        modeloSQL = updateModelo(modeloSQL);
