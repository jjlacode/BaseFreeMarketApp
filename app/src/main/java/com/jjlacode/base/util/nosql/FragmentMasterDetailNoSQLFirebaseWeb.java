...
public abstract class FragmentMasterDetailNoSQLFirebaseWeb
        extends FragmentMasterDetailNoSQL implements ContratoSystem.Tablas {
    ...
    protected abstract String setWeb();
