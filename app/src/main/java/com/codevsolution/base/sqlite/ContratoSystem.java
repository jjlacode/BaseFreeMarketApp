...
public class ContratoSystem implements JavaUtil.Constantes {
    ...
    public interface Tablas {
        ...
        String[] CAMPOS_MARCADOR = {"32", TABLA_MARCADOR,
                ...
                MARCADOR_ALCANCE, "INTEGER NON NULL DEFAULT 1", INT,
                MARCADOR_ACTIVO, "INTEGER NON NULL DEFAULT 1", INT,
                MARCADOR_LATITUD, "INTEGER NON NULL", LONG,
                MARCADOR_LONGITUD, "INTEGER NON NULL", LONG,
                MARCADOR_TIPO, "TEXT NON NULL", STRING,
                MARCADOR_CREATE, "INTEGER NON NULL DEFAULT 0", LONG,
                MARCADOR_TIMESTAMP, "INTEGER NON NULL DEFAULT 0", LONG
