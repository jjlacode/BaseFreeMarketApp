...
public abstract class ListadoPerfilesFirebase extends FragmentMasterDetailNoSQLFormBaseFirebaseRatingWeb implements ContratoPry.Tablas {
    ...
    protected void setOnCreateView(View view, LayoutInflater inflater, ViewGroup container) {
        ...
        proveedores = vistaBtns.addButtonSecondary(R.string.importar_a_proveedores, 1);
