...
public class FragmentCRUDProyecto extends FragmentCRUD
    ...
    private void actualizarConsultas() {
        ...
        if (listab == null) {
            lista = setListaModelo(campos);
        } else {
            inicio.setVisibility(View.VISIBLE);
            lista = clonaListaModelo(campos, listab);
        }
        ...
        if (lista.chechLista()) {
            ...
            lista = clonaListaModelo(campos, listatemp);
    ...
    protected void setAcciones() {
        ...
        chSplit.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                ...
                if (b) {
                    actualizarCampo(modeloSQL, PROYECTO_SPLIT, 1);
                    modeloSQL = updateModelo(modeloSQL);
                } else {
                    actualizarCampo(modeloSQL, PROYECTO_SPLIT, 0);
                    modeloSQL = updateModelo(modeloSQL);
                }
            }
        });
        ...
        chFija.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                ...
                if (b) {
                    actualizarCampo(modeloSQL, PROYECTO_FIJA, 1);
                    modeloSQL = updateModelo(modeloSQL);
                } else {
                    actualizarCampo(modeloSQL, PROYECTO_FIJA, 0);
                    modeloSQL = updateModelo(modeloSQL);
                }
            }
        });
    ...
    private void nuevoEvento() {
        update();
        ModeloSQL cliente = consultaBD.queryObject(CAMPOS_CLIENTE, idCliente);
    ...
    private void calculoTotales() {
        ...
        ArrayList<ModeloSQL> listaPartidas = consultaBD.queryListDetalle(CAMPOS_PARTIDA, id);
    ...
    private void comprobarEstado() {
        ...
        ModeloSQL proyecto = consultaBD.queryObject(CAMPOS_PROYECTO, id);
    ...
    private void modificarEstado() {
        ...
        actualizaRegistro(TABLA_PROYECTO, id, valores);
        actualizarRegistro(modeloSQL, valores);
    ...
    private String generarPDF(String id) {
        ...
        ModeloSQL modeloSQL = updateModelo(CAMPOS_PROYECTO, id);
        ...
        int res = actualizaRegistro(modeloSQL.getNombreTabla(), id, valores);
    ...
    private void modificarEstadoPartidas(String idProyecto, String idEstado) {
        ...
        actualizaRegistroDetalle(TABLA_PARTIDA, idProyecto, TABLA_PROYECTO, valores);
        ...
        DatePickerFragment newFragment = DatePickerFragment.newInstance
                (JavaUtil.hoy(), new DatePickerDialog.OnDateSetListener() {
                    ...
                    public void onDateSet(DatePicker datePicker, int year, int month, int day) {
                        ...
                        actualizaRegistro(tabla, id, valores);
        ...
        public void bind(ModeloSQL modeloSQL) {
            ...
            if (actualtemp.equals(PROYECTO)) {
                ...
                if (retraso > 3 * DIASLONG) {
                    imagenEstado.setImageResource(R.drawable.alert_box_r);
                } else if (retraso > DIASLONG) {
                    imagenEstado.setImageResource(contexto, R.drawable.alert_box_a);
                } else {
                    imagenEstado.setImageResource(R.drawable.alert_box_v);
                }
            ...
            if (peso > 6) {
                imagenCliente.setImageResource(R.drawable.clientev);
            } else if (peso > 3) {
                imagenCliente.setImageResource(R.drawable.clientea);
            } else if (peso > 0) {
                imagenCliente.setImageResource(R.drawable.clienter);
            } else {
                imagenCliente.setImageResource(R.drawable.cliente);
            }
