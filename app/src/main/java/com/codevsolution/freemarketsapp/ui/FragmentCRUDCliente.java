...
public class FragmentCRUDCliente extends FragmentCRUD implements Interactor.ConstantesPry,
    ...
    protected void setNuevo() {
        ...
        objTiposCli = setListaModelo(CAMPOS_TIPOCLIENTE).getLista();//queryList(CAMPOS_TIPOCLIENTE);
    ...
    protected void setDatos() {
        ...
        ListaModeloSQL listaEventos = setListaModelo(CAMPOS_EVENTO, EVENTO_CLIENTEREL, id, IGUAL);
        if (listaEventos.sizeLista() > 0) {
            btnVerEventos.setVisibility(View.VISIBLE);
        } else {
            btnVerEventos.setVisibility(View.GONE);
        ...
        ListaModeloSQL listaNotas = setListaModelo(CAMPOS_NOTA, NOTA_ID_RELACIONADO, id, IGUAL);
